...
file1_path = r'C:\chemin\vers\file1.txt'  # Remplacez par le chemin de votre premier fichier
file2_path = r'C:\chemin\vers\file2.txt'  # Remplacez par le chemin de votre second fichier
output_file = r'C:\chemin\vers\output_diff.txt'  # Chemin pour sauvegarder les différences
